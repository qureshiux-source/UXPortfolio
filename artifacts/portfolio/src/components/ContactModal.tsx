            ...
            >
              ...
              <div style={{
                ...
                <span style={{
                  ...
                  fontWeight: 800, letterSpacing: "0.2em", textTransform: "uppercase", color: green,
              ...
              <p style={{
                ...
                lineHeight: 1.6, color: body, margin: "0 0 22px",
              }}>
              ...
              <a
                ...
                onMouseLeave={e => {
                  const el = e.currentTarget as HTMLElement;
                  el.style.background = "rgba(37,211,102,0.09)";
                  el.style.borderColor = "rgba(37,211,102,0.22)";
                }}
              >
                <div style={{
                  width: 34, height: 34, borderRadius: 9, flexShrink: 0,
